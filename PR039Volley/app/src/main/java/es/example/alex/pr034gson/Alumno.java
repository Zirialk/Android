...
public class Alumno extends ListItem{
    ...
    public static final String KEY_NOMBRE = "kNombre", KEY_CURSO = "kCurso", KEY_TELEFONO = "kTelefono", KEY_EDAD = "kEdad", KEY_DIRECCION = "kDireccion", KEY_REPETIDOR ="kRepetidor", KEY_FOTO = "kFoto";
