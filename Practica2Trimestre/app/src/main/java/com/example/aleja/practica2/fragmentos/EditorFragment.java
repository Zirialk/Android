...
public class EditorFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        //Coloca el fab en el debajo del imgFoto
        fab.animate().translationY(imgFoto.getLayoutParams().height - fab.getY()).setDuration(1000);
        fab.setImageDrawable(getResources().getDrawable(R.drawable.ic_photo_camera_white_24dp));
