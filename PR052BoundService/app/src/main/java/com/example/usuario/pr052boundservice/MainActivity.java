...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener, View.OnClickListener, ServiceConnection {

    //Variables
    private MuscaOnlineService mServicio;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFiltro = new IntentFilter(MuscaOnlineService.ACTION_PLAYING);
    ...
    private void vincularServicio() {
        ...
        intent = new Intent(getApplicationContext(), MuscaOnlineService.class);
    ...
    public void onServiceConnected(ComponentName className, IBinder binder) {
        ...
        mServicio = ((MuscaOnlineService.LocalBinder) binder).getService();
